...
PairLJ69Wall::PairLJ69Wall(LAMMPS *lmp) : Pair(lmp)
{
  respa_enable = 0;
}
...
void PairLJ69Wall::compute(int eflag, int vflag)
{
...
void PairLJ69Wall::settings(int narg, char **arg)
{
...
void PairLJ69Wall::coeff(int narg, char **arg)
{
  if (narg < 5 || narg > 6)
...
double PairLJ69Wall::init_one(int i, int j)
{
  if (setflag[i][j] == 0) {
  ...
  foffset[i][j] = 4.0 * epsilon[i][j] * (9.0 * pow(ratio,9.0) -
                                         6.0 * pow(ratio,6.0));
...
void PairLJ69Wall::write_restart(FILE *fp)
{
...
void PairLJ69Wall::read_restart(FILE *fp)
{
...
void PairLJ69Wall::write_restart_settings(FILE *fp)
{
...
void PairLJ69Wall::read_restart_settings(FILE *fp)
{
  int me = comm->me;
  if (me == 0) {
...
double PairLJ69Wall::single(int i, int j, int itype, int jtype, double rsq,
                         double factor_coul, double factor_lj,
                         double &fforce)
{
  double r2inv,r3inv,r6inv,forcelj,philj,r,t;
